...
Original file is located at
    https://colab.research.google.com/drive/1OyWm79_E10QW0n_DAmnRaT4Tur99Uxoc
"""

# For running inference on the TF-Hub module.
import tensorflow as tf

#TensorFlow Hub est un dépôt de modèles de machine learning entraînés, prêts à être optimisés et déployés n'importe où. Vous pouvez réutiliser des modèles
#entraînés comme BERT et Faster R-CNN avec simplement quelques lignes de code.
...
def draw_bounding_box_on_image(image,
    ...
    # instead of above.(Si la hauteur totale des chaînes d'affichage ajoutées en haut de la limite boîte dépasse le haut de l'image, empilez les chaînes en dessous de la boîte englobante au lieu d'en haut.)
    ...
    # Reverse(inverser) list and print from bottom to top.
...
def run_detector(detector, path):
    ...
    #print("boxes", result["detection_boxes"])
